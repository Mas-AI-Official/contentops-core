...
- **Multi-Platform Publishing**: Official API integrations for YouTube, Instagram, and TikTok
...
- Pull required LLM models (llama3.1:8b, llama3.2:3b)
- Create default niche templates with example prompts
